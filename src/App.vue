<template>
    ...
    >
      <div class="flex items-center">
        <img
          class="rounded-full"
          width="27"
          src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Escudo_de_Belgrano_de_C%C3%B3rdoba.svg/1200px-Escudo_de_Belgrano_de_C%C3%B3rdoba.svg.png"
          alt=""
        >
        <div class="text-white text-[14px] ml-1.5 font-semibold">Vachu</div>
  ...
  >
    <RouterLink to="/">
      <img src="/public/images/icons/spotify-logo.png" width="125" alt="logo">
    </RouterLink>
    <div class="my-8"></div>
    <ul>
